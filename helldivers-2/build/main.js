...
pug_html = pug_html + "\u003Ctd" + (" class=\"arc label\""+pug_attr("title", t('table.th.arc', 'range', 'Arc range (m)'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.td.arc.label', 'range', 'Arc')) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc range stub\"\u003E" + (pug_escape(null == (pug_interp = arc.range) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc angle stub\"\u003E" + (pug_escape(null == (pug_interp = `${arc.angle}°`) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc filler\" colspan=\"4\"\u003E\u003C\u002Ftd\u003E\u003Ctd class=\"arc name\"\u003E" + (pug_escape(null == (pug_interp = arc.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
};
...
if (opts.full) {
pug_html = pug_html + "\u003Cth" + (" class=\"damage dmg\""+pug_attr("title", t('table.th.dmg', 'dmgs3', 'Damage type / Base damage / Damage vs Massive'), true, false)+" colspan=\"3\"") + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.dmg.label', 'dmgs3', 'Damage')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
