...
const n = count(wpn)
pug_html = pug_html + "\u003Ctd" + (pug_attr("class", pug_classes(["weapon","pellets",{ muted: n == 1, blank: !n }], [false,false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = n) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd" + (pug_attr("class", pug_classes(["weapon","dmg",{ xdmg: !!wpn.explosion }], [false,false,true]), false, false)+" colspan=\"2\"") + "\u003E";
if (dmg.dmg) {
...
pug_html = pug_html + "\u003Ctd" + (" class=\"arc label\""+pug_attr("title", t('table.td.arc', 'range', 'Arc range (m)'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.td.arc.label', 'range', 'Arc')) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc velocity stub\"\u003E" + (pug_escape(null == (pug_interp = arc.velocity) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc range stub\"\u003E" + (pug_escape(null == (pug_interp = arc.range) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc aimangle stub\"\u003E" + (pug_escape(null == (pug_interp = `${arc.aimangle}°`) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc chainangle stub\"\u003E" + (pug_escape(null == (pug_interp = `${arc.chainangle}°`) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc filler\" colspan=\"2\"\u003E\u003C\u002Ftd\u003E\u003Ctd class=\"arc name\"\u003E" + (pug_escape(null == (pug_interp = arc.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
};
...
pug_html = pug_html + "\u003C\u002Ftr\u003E\u003C\u002Ftfoot\u003E\u003C\u002Ftable\u003E";
if (scope === 'weapons') {
