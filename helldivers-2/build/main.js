...
var pug_match_html=/["&<>]/;function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (catClass, cats, collapseDamage, colspans, count, effect, full, getHeader, getRow, headerClass, headers, hideHeaders, hideName, id, isWeaponScope, langs, objects, roundStart, scope, scopeClass, scopes, search, showIds, sourceClass, sources, subObj, subScope, t, tbody, text, wikiLink) {pug_mixins["weaponsHeader"] = pug_interp = function(){
...
if (wpn.charge) {
pug_html = pug_html + "\u003Cspan class=\"rpm-charge time\" title=\"Charge time\"\u003E\u003Csup class=\"one-over\"\u003E1\u002F\u003C\u002Fsup\u003E";
if (wpn.chargeearly) {
...
if (wpn.reloadone) {
pug_html = pug_html + "\u003Cspan" + (" class=\"reload-one\""+pug_attr("title", t('table.td.reload', '1'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = wpn.reloadone.toFixed(1)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
if (wpn.reloadx) {
pug_html = pug_html + "\u003Cspan" + (" class=\"reload-x pre-slash\""+pug_attr("title", t('table.td.reload', 'x'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = wpn.reloadx.toFixed(1)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
if (wpn.reload) {
pug_html = pug_html + "\u003Cspan" + (" class=\"reload-main\""+pug_attr("title", t('table.td.reload', 'empty'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = wpn.reload.toFixed(1)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
if (wpn.reloadearly) {
pug_html = pug_html + "\u003Cspan" + (" class=\"reload-early post-slash\""+pug_attr("title", t('table.td.reload', 'early'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = wpn.reloadearly.toFixed(1)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
if (wpn.heatdown) {
pug_html = pug_html + "\u003Cspan" + (" class=\"reload-heat\""+pug_attr("title", t('table.td.reload', 'heat'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = wpn.heatdown.toFixed(1)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003C\u002Ftd\u003E\u003Ctd class=\"weapon cap\"\u003E" + (pug_escape(null == (pug_interp = wpn.limit || wpn.cap) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"weapon capextra\"\u003E";
if (wpn.limit) {
...
if (wpn.recoilxy) {
pug_html = pug_html + "\u003Cspan class=\"recoil-x pre-slash\"\u003E" + (pug_escape(null == (pug_interp = wpn.recoilxy.x.toFixed()) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan class=\"recoil-y\"\u003E" + (pug_escape(null == (pug_interp = wpn.recoilxy.y.toFixed()) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
...
pug_html = pug_html + "\u003Cspan class=\"salvos\"\u003E" + (pug_escape(null == (pug_interp = obj.salvos || obj.magazines) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003Cspan class=\"strat-cap\"\u003E" + (pug_escape(null == (pug_interp = obj.cap || obj.limit || obj.magazine_capacity) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Ftd\u003E\u003Ctd class=\"stratagem capextra\"\u003E";
if (obj.limit) {
pug_html = pug_html + "\u003Cspan class=\"cap-limit\"\u003Es\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003C\u002Ftd\u003E";
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (opts.full) {
pug_html = pug_html + "\u003Cth" + (" class=\"projectile idx\""+pug_attr("title", t('table.th.prj', 'idx', 'Internal order'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.prj.label', 'idx')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
}
...
if (opts.full) {
pug_html = pug_html + "\u003Cth" + (" class=\"projectile pellets\""+pug_attr("title", t('table.th.prj', 'pellets', 'Pellet Count'), true, false)) + "\u003E\u003C\u002Fth\u003E";
}
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (opts.full) {
pug_html = pug_html + "\u003Ctd class=\"projectile idx\"\u003E" + (pug_escape(null == (pug_interp = prj.idx) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
}
pug_html = pug_html + "\u003Ctd" + (" class=\"projectile name\""+pug_attr("title", prj.ref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = prj.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
if (opts.full) {
pug_html = pug_html + "\u003Ctd" + (pug_attr("class", pug_classes(["projectile","pellets",{ muted: prj.pellets < 2 }], [false,false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = prj.pellets) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
}
...
if (opts.full) {
pug_html = pug_html + "\u003Ctd" + (" class=\"projectile ximpactid\""+pug_attr("title", prj.ximpactref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = prj.ximpactref && '✓') ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd" + (pug_attr("class", pug_classes(["projectile","xdelay",{ muted: !prj.xdelay }], [false,false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = prj.xdelay) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd" + (" class=\"projectile xdelayid\""+pug_attr("title", prj.xdelayref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = prj.xdelayref && '✓') ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
}
};
pug_mixins["explosionsHeader"] = pug_interp = function(opts = {}){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (opts.full) {
pug_html = pug_html + "\u003Cth" + (" class=\"explosion idx\""+pug_attr("title", t('table.th.aoe', 'idx', 'Internal order'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.aoe.label', 'idx')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth" + (" class=\"explosion name\""+pug_attr("title", t('table.th.aoe', 'name', 'Translated name of AoE source'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.aoe.label', 'name', 'Explosion')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
}
...
if (opts.full) {
pug_html = pug_html + "\u003Cth" + (" class=\"explosion shrapnel\""+pug_attr("title", t('table.th.aoe', 'shrapnel', 'Amount of Shrapnel Released'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.aoe.label', 'shrapnel')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
}
};
...
if (opts.full) {
pug_html = pug_html + "\u003Ctd" + (" class=\"explosion name\""+pug_attr("title", exp.ref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = exp.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
}
...
pug_html = pug_html + "\u003C\u002Ftd\u003E";
if (opts.full) {
pug_html = pug_html + "\u003Ctd" + (pug_attr("class", pug_classes(["explosion","shrapnel",{ muted: !exp.shrapnel }], [false,false,true]), false, false)+pug_attr("title", exp.shrapnelref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = exp.shrapnel) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
}
};
pug_mixins["beamsHeader"] = pug_interp = function(opts = {}){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cth" + (" class=\"beam idx\""+pug_attr("title", t('table.th.beam', 'idx', 'Internal order'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.beam.label', 'idx')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth" + (" class=\"beam name\""+pug_attr("title", t('table.th.beam', 'name', 'Translated name of beam'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.beam.label', 'name', 'beam')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth" + (" class=\"beam range\""+pug_attr("title", t('table.th.beam', 'range', 'Max range (m)'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.beam.label', 'range', 'Range')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
};
pug_mixins["beamsRow"] = pug_interp = function(beam, opts = {}){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctd class=\"beam idx\"\u003E" + (pug_escape(null == (pug_interp = beam.idx) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd" + (" class=\"beam name\""+pug_attr("title", beam.ref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = beam.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"beam range\"\u003E" + (pug_escape(null == (pug_interp = beam.range) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
};
pug_mixins["beamsStubRow"] = pug_interp = function(beam, opts = {}){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctd" + (" class=\"beam label\""+pug_attr("title", t('table.th.beam', 'range', 'Beam range (m)'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.td.beam.label', 'range', 'Beam')) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"beam range stub\"\u003E" + (pug_escape(null == (pug_interp = beam.range) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"beam filler\" colspan=\"7\"\u003E\u003C\u002Ftd\u003E\u003Ctd" + (" class=\"beam name stub\""+pug_attr("title", beam.ref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = beam.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
};
pug_mixins["arcsHeader"] = pug_interp = function(opts = {}){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cth" + (" class=\"arc idx\""+pug_attr("title", t('table.th.arc', 'idx', 'Internal order'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label', 'idx')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth" + (" class=\"arc name\""+pug_attr("title", t('table.th.arc', 'name', 'Translated name of arc'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label', 'name', 'arc')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth" + (" class=\"arc velocity\""+pug_attr("title", t('table.th.arc', 'velocity', 'Velocity (m/s)'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label', 'velocity', 'v')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth" + (" class=\"arc range\""+pug_attr("title", t('table.th.arc', 'range', 'Max range (m)'), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label', 'range', 'Range')) ? "" : pug_interp)) + "\u003C\u002Fth\u003E\u003Cth" + (" class=\"arc aimangle\""+pug_attr("title", t('table.th.arc', 'aimangle', 'Aim angle (°)'), true, false)) + "\u003E\u003Csup\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label.sup', 'aimangle', '∠')) ? "" : pug_interp)) + "\u003C\u002Fsup\u003E\u003Csub\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label.sub', 'aimangle', 'aim')) ? "" : pug_interp)) + "\u003C\u002Fsub\u003E\u003C\u002Fth\u003E\u003Cth" + (" class=\"arc chainangle\""+pug_attr("title", t('table.th.arc', 'chainangle', 'Chain angle (°)'), true, false)) + "\u003E\u003Csup\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label.sup', 'chainangle', '∠')) ? "" : pug_interp)) + "\u003C\u002Fsup\u003E\u003Csub\u003E" + (pug_escape(null == (pug_interp = t('table.th.arc.label.sub', 'chainangle', 'ch')) ? "" : pug_interp)) + "\u003C\u002Fsub\u003E\u003C\u002Fth\u003E";
};
pug_mixins["arcsRow"] = pug_interp = function(arc, opts = {}){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ctd class=\"arc idx\"\u003E" + (pug_escape(null == (pug_interp = arc.idx) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd" + (" class=\"arc name\""+pug_attr("title", arc.ref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = arc.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc velocity\"\u003E" + (pug_escape(null == (pug_interp = arc.velocity) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc range\"\u003E" + (pug_escape(null == (pug_interp = arc.range) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc aimangle\"\u003E" + (pug_escape(null == (pug_interp = `${arc.aimangle}°`) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E\u003Ctd class=\"arc chainangle\"\u003E" + (pug_escape(null == (pug_interp = `${arc.chainangle}°`) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
};
...
let i
if (opts.full && !opts.hideId) {
pug_html = pug_html + "\u003Ctd class=\"damage idx\"\u003E" + (pug_escape(null == (pug_interp = dmg.idx) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
}
if (opts.full && !opts.hideName) {
pug_html = pug_html + "\u003Ctd" + (" class=\"damage name\""+pug_attr("title", dmg.ref, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = dmg.name) ? "" : pug_interp)) + "\u003C\u002Ftd\u003E";
}
if (opts.full) {
pug_html = pug_html + "\u003Ctd" + (pug_attr("class", pug_classes(["damage","dmgtype",{muted: !dmg.type }], [false,false,true]), false, false)+pug_attr("title", t('dmg.types.full', dmg.element), true, false)) + "\u003E";
if (dmg.element) {
var el = dmg.element
pug_html = pug_html + "\u003Cspan" + (" class=\"dmgtype\""+pug_attr("title", t('dmg.types.full', el), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = t('dmg.types', el)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
...
if (scope === 'weapons') {
pug_html = pug_html + "\u003Cul\u003E\u003Cli\u003E" + (pug_escape(null == (pug_interp = t('explanations', 'reload')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug_escape(null == (pug_interp = t('explanations', 'startingMagsDisclaimer')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003Cli\u003E" + (pug_escape(null == (pug_interp = t('explanations', 'outdated')) ? "" : pug_interp)) + "\u003C\u002Fli\u003E\u003C\u002Ful\u003E";
}
};
